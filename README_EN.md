...
**v1.20.0** | **Turn any AI coding agent into your personal knowledge management assistant.**
...
The current stable release is **v1.20.0**. See [CHANGELOG.md](CHANGELOG.md) for release history and upgrade notes.
