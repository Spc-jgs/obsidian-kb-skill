...
> **Version**: 1.1.0
>
> **Source of truth**: This file (`core/OBSIDIAN_KB.md`) is the single source of truth for all platform adapters (QoderWork SKILL.md, Claude Code CLAUDE.md, Codex AGENTS.md, Cursor .mdc). Each adapter is generated by `build.py` = `platforms/{name}/header.md` + this body (starting from "## Overview"). **Do not edit the generated adapter files directly — edit this file and re-run `python build.py`.**
