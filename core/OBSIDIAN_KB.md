...
> **Version**: 1.9.0
>
> **Single source of truth**: `core/OBSIDIAN_KB.md` is the source for the standard
> Skill and all compatibility adapters. The detailed workflows live in
> `core/references/*.md` and are loaded by an agent **only when it is about to save
> something**. This file is kept tiny on purpose: loading the skill costs almost no
> tokens, and the first rule below is "do not auto-save".
> **Do not edit generated files directly — edit this file or a header, then `python build.py`.**
